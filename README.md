1.Developed a basic MERN (MongoDB, Express, React, Node.js) project, "AddUsers", that demonstrates CRUD (Create, Read, Update, Delete) operations for user management.
